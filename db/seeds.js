...
const littleSnowboard = new SnowboardModel({ name: "Little Snowboard", price: 12 })
const bigSnowboard = new SnowboardModel({ name: "Big Snowboard", price: 13 })
const blueSnowboard = new SnowboardModel({ name: "Blue Snowboard", price: 22 })


var companies = [burton, dc, ktwo]
var snowboards = [littleSnowboard, bigSnowboard, blueSnowboard]
